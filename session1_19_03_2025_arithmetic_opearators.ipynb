 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    ".ipynb uzantısı Jupyter Notebook dosya formatıdır. Bu uzantıya sahip dosyalar, JSON tabanlı bir yapıya sahiptir ve hücreler halinde kod çalıştırmaya izin verir. GitHub, .ipynb dosyalarını Jupyter Notebook olarak tanır ve önizleme olarak render eder."
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "source": [
    "Kernel Nedir?\n",
    "Kernel, bir programlama dili için çalıştırma (execution) motoru olarak görev yapan bir bileşendir. Özellikle Jupyter Notebook gibi interaktif ortamlarda, yazdığın kodun çalıştırılmasını ve çıktıların yönetilmesini sağlar.\n",
    "\n",
    "Kernel'in Görevleri\n",
    "\n",
    "Kod Çalıştırma:\n",
    "Sen bir kod hücresini çalıştırdığında, kernel bu kodu alır, çalıştırır ve sonucu geri döndürür.\n",
    "\n",
    "Bellek Yönetimi:\n",
    "Değişkenler, nesneler ve diğer veriler bellekte kernel tarafından tutulur.\n",
    "\n",
    "Hata Yönetimi:\n",
    "Hata mesajları ve uyarılar kernel tarafından işlenir ve ekrana yazdırılır.\n",
    "\n",
    "Farklı Diller İçin Çalışabilir:\n",
    "Kernel sadece Python için değil, R, Julia, JavaScript, Scala gibi farklı diller için de olabilir.\n",
    "\n",
    "Jupyter Notebook’ta Kernel Kullanımı\n",
    "Çalışan Kernel'i Göster:\n",
    "Jupyter Notebook'un sağ üst köşesinde seçili kernel görünür. Örneğin: Python 3 (ipykernel).\n",
    "Kernel'i Yeniden Başlatma:\n",
    "Eğer kodda değişiklik yaptıysan ve her şeyi sıfırdan çalıştırmak istiyorsan:\n",
    "Kernel → Restart & Run All seçeneğini kullanabilirsin.\n",
    "Kernel Donarsa Ne Olur?\n",
    "Çalıştırdığın kod çok uzun sürerse veya takılırsa, kernel kilitlenebilir. Bunu Restart Kernel yaparak düzeltebilirsin."
   ]
  },
  {
   "cell_type": "markdown",
